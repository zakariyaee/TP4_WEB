...
function loadUsers(page = currentPage, forceRefresh = false) {
    ...
    const url = `../../actions/admin-manager/user/get_users.php?search=${encodeURIComponent(search)}&role=${role}&statut=${statut}&page=${page}&limit=${itemsPerPage}`;
...
function editUser(email) {
    ...
    const xhr = new XMLHttpRequest();
    // Security: encodeURIComponent prevents XSS in URL parameters
    xhr.open('GET', `../../actions/admin-manager/user/get_user.php?email=${encodeURIComponent(email)}`, true);
...
function handleSubmit(e) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', currentEmail ? '../../actions/admin-manager/user/edit_user.php' : '../../actions/admin-manager/user/add_user.php', true);
...
function confirmDelete() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', '../../actions/admin-manager/user/delete_user.php', true);
    xhr.setRequestHeader('Content-Type', 'application/json');
...
function toggleUserStatus(email, isActive) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', '../../actions/admin-manager/user/update_user_status.php', true);
    xhr.setRequestHeader('Content-Type', 'application/json');

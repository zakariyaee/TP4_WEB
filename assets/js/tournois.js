...
function loadTournois(forceRefresh = false) {
    ...
    xhr.open('GET', `../../actions/admin-respo/get_tournois.php?search=${encodeURIComponent(search)}&statut=${statut}&type=${type}`, true);
...
function editTournoi(id) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('GET', `../../actions/admin-respo/get_tournoi.php?id=${id}`, true);
...
function handleSubmit(e) {
    ...
    xhr.open('POST', currentTournoiId ? '../../actions/admin-respo/edit_tournoi.php' : '../../actions/admin-respo/add_tournoi.php', true);
...
function confirmDelete() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', '../../actions/admin-respo/delete_tournoi.php', true);
    xhr.setRequestHeader('Content-Type', 'application/json');

          ...
          <div class="bg-white rounded-xl shadow-sm p-6 border border-slate-200 hover:-translate-y-1 hover:shadow-lg transition-transform duration-300">
            <div class="flex items-start justify-between">
              <div>
                ...
                <h3 class="text-4xl font-bold text-slate-800">1,284</h3>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 border border-slate-200 hover:-translate-y-1 hover:shadow-lg transition-transform duration-300">
            <div class="flex items-start justify-between">
              <div>
                ...
                <h3 class="text-4xl font-bold text-slate-800">45,230 €</h3>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 border border-slate-200 hover:-translate-y-1 hover:shadow-lg transition-transform duration-300">
            <div class="flex items-start justify-between">
              <div>
                ...
                <h3 class="text-4xl font-bold text-slate-800">24</h3>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 border border-slate-200 hover:-translate-y-1 hover:shadow-lg transition-transform duration-300">
            <div class="flex items-start justify-between">
              <div>
                ...
                <h3 class="text-4xl font-bold text-slate-800">892</h3>
  ...
  <script>
    ...
    new Chart(ctxLine, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Revenus (€)',
          data: [32000, 34000, 40000, 38000, 44000, 47000],
          borderColor: '#10b981',
    ...
    new Chart(ctxPie, {
      type: 'doughnut',
      data: {
        labels: ['Terrain Moyen 45%', 'Mini Foot 35%', 'Grand Terrain 20%'],
        datasets: [{
          data: [45, 35, 20],
